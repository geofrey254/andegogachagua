...
const Contact_page = () => {
  ...
  return (
    <section className="min-h-screen contact">
      <div className="container flex flex-col min-h-screen px-6 py-12 mx-auto">
        <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
          <div className="text-white lg:w-1/2 lg:mx-6">
            <h1 className="text-2xl font-semibold capitalize md:text-4xl text-white">
              Talk to Us
            </h1>
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full bg-cont px-8 py-10 mx-auto overflow-hidden shadow-2xl rounded-xl  lg:max-w-xl">
