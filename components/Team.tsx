    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
        ...
        <div>
          ...
          <div className="flex flex-col sm:text-center">
            <p className="text-lg font-bold">Barbara Owino</p>
            <p className="mb-5 text-xs text-gray-800">Associate</p>
            <div className="flex items-center space-x-3 sm:justify-center">
              <a
                href="/"
        ...
        <div>
          ...
          <div className="flex flex-col sm:text-center">
            <p className="text-lg font-bold">Vito Otieno</p>
            <p className="mb-5 text-xs text-gray-800">Associate</p>
            <div className="flex items-center space-x-3 sm:justify-center">
              <a
                href="/"
        ...
        <div>
          ...
          <div className="flex flex-col sm:text-center">
            <p className="text-lg font-bold">Esther Muritu</p>
            <p className="mb-5 text-xs text-gray-800">
              Consultant Energy & Natural Resources
            </p>
            <div className="flex items-center space-x-3 sm:justify-center">
              <a
                href="/"
