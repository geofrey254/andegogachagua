...
export const NAV_LINKS = [
    ...
    { href: '/team', key: 'our_team', label: 'Our Team' },    
    { href: '/practice_areas', key: 'practice_areas', label: 'Practice Areas' },
  ...
  export const PEOPLE = [
...

    {
      ...
      imageUrl:
        ...
        description:"Claire holds an LLB from the Jomo Kenyatta University of Agriculture and Technology and is undertaking pupillage to satisfy the requirements for a post-graduate Diploma in Law from the Kenya School of Law. She previously served as Research Aassistant at the Institute for Research and Policy Alternatives (IRPA) and intern at Kimenyi & Co. Advocates, honing her research and legal skills effectively.Claire has experience in Human Rights, Labour and Family Law. She champions the rights of marginalized groups, ensures fair treatment in labour issues and proficient in navigating sensitive family matters, she approaches them with empathy and professionalism. She has a keen interest in the complex landscape of corporate governance, business regulations and contractual matters, aiming to facilitate ethical and sustainable business practices. She is continuously engaged in legal research, staying updated to offer informed counsel. Her strong foundation in law and a commitment to justice position her to address pressing legal challenges and promote fairness and integrity. Claire's drive and passion promise a rewarding career, impacting both the legal community and society at large."
    },
