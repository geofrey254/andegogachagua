        ...
        <div className="sm:col-span-2">
          ...
          >
            <Image
              ...
              className="logo"
            ></Image>
            <span className="ml-2 md:text-xl text-sm font-bold tracking-wide text-white uppercase">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              title="Our phone"
              className="transition-colors duration-300 text-red-500 hover:no-underline"
            >
              +254728 547 650
            </a>
          </div>
